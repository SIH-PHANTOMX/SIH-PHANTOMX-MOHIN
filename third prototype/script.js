...
style.textContent = `
    ...
    .profile-card, .stats-card, .alumni-highlights-card, .network-card, .quick-actions {
        transition: all 0.3s ease;
    }
    
    .profile-card:hover, .stats-card:hover, .alumni-highlights-card:hover, .network-card:hover, .quick-actions:hover {
